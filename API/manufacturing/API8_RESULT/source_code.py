...
# local
from manufacturing.API8_RESULT.R import runScript
# 플랫폼
...
def R_graph(value):
    ...
    design_output_path, result_output_path = runScript(value)
    design = design_output_path['ch_design']
    result = result_output_path['ch_result']

    design_path_list = get_graph_list(design)
    result_path_list = get_graph_list(result)

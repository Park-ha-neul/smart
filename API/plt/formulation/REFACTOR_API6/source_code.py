...
def mkdir(value):
    ...
    logging.info("pareto_path : %s", pareto_path)
    contour_path = value['contour-path']
    logging.info("contour_path : %s", contour_path)
    response_path = value['response-path']
    logging.info("response_path : %s", response_path)

    if os.path.isdir(pareto_path) :
        pass
    else:
        logging.info("@@@@@@@@@@@@@@@ pareto_path mkdir")
        os.makedirs(pareto_path)
    if os.path.isdir(contour_path) :
        pass
    else:
        logging.info("@@@@@@@@@@@@@@@ contour_path mkdir")
        os.makedirs(contour_path)
    if os.path.isdir(response_path) :
        pass
    else:
        logging.info("@@@@@@@@@@@@@@@ response_path mkdir")

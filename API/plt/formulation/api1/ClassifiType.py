...
def ClassifiType(value):
    ...
    if value['type'] == 'chemical':
        ...
        if input_value in dict_from_csv:
            ...
            res_dict = {"molecule":{"smiles": smiles, "generated Molecule":mc.SmilesToImg(smiles, png_path)},"properties":properties,"dosage":ds.dosage(out_array),'count':ds.count(out_array)}
    ...
    # elif "smiles" in values:
        ...
        logging.info('ttttttttttttttttype - smiles %%%%%%%%%%%%%%%%%%%')
        ...
        png_path = mkdir(input_path)
        success_result = mc.SmilesToImg(smiles, png_path)
    ...
    # elif "sdf" in values:
        ...
        res_dict = {"molecule":{"smiles": smiles, "generated Molecule":mc.SdfToPng2(png_path, sdf_path)},"properties":properties,"dosage":ds.dosage(out_array),'count':ds.count(out_array)}
        # properties 키 값에 properties 변수 대입한다.

...
def RecExcipients(value, params): #value > 입력값, params > init_svc에서 가져온 params
    ...
    ## 2. {smiles/formulation/primay}의 value가 누락된 경우
        ...
        pass
    ## 3. smiles string이 존재하지 않을때(chemical,csv 파일에 있는 11만개의 smiles string이 존재하지 않는 경우)
#     elif (value['smiles']==chemical_df['DATA_CANONICAL_SMILES']).any():
#         pass
#     else:
#         pass
        # rxlist 데이터에 smiles 가 없는 경우
#         code="005"
